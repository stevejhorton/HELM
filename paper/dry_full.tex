...
\thanks{%
Network Architect, Optum/UnitedHealthcare; MS Cyber Security; Independent Researcher \\
\href{mailto:sjhorton@captechu.edu}{\texttt{sjhorton@captechu.edu}} \\
\href{https://github.com/stevejhorton/HELM}{GitHub: stevejhorton/HELM} \textbar\ 
\href{https://orcid.org/0009-0006-8205-2518}{ORCID: 0009-0006-8205-2518} \\
\href{https://www.linkedin.com/in/stevejhorton}{LinkedIn: stevejhorton} \textbar\ 
\href{https://www.reverbnation.com/stevejhorton}{ReverbNation: stevejhorton}
}%
}
...
The sub-lattice spacing $a_g$ is \emph{predicted} (Section 3.1) from the requirement that both quantum and gravitational scales emerge from the same tension $\sigma$: from $\hbar c = \sigma a_g^2$ and $\hbar = \sigma a_0^2/(\pi c)$, we obtain $a_g = a_0/\sqrt{\pi}$.
...
\begin{equation}
a_g = \sqrt{\frac{G m_{\rm Pl}^2}{\sigma c}} = \sqrt{\frac{G (\hbar c / G)}{\sigma c}} = \sqrt{\frac{\hbar c}{\sigma}}
\end{equation}
Substitute $\hbar = \sigma a_0^2 / (\pi c)$:
\begin{equation}
a_g = \sqrt{\frac{[\sigma a_0^2 / (\pi c)] \cdot c}{\sigma}} = \sqrt{\frac{a_0^2}{\pi}} = \frac{a_0}{\sqrt{\pi}} = 0.475 \text{ fm}
\end{equation}
